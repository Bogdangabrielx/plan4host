...
export default function AppShell({ title, currentPath, children }: Props) {
  ...
  // —— detectăm rapid PWA/standalone pentru backdrop —
  ...
  return (
    <HeaderProvider initialTitle={title ?? ""}>
      <>
        <style
          dangerouslySetInnerHTML={{
            __html: `
              ...
              /* Asigură că elementul Next.js pentru SR nu afectează compozitarea */
        ...
        {/* 🔧 Backdrop fix, doar în PWA: acoperă gradientul de pe <body> */}
        {standalone && (
          <div
            aria-hidden
            style={{
        ...
        {/* tot app-ul într-un stacking context deasupra backdrop-ului */}
        <div
          style={{
            position: "relative",
            zIndex: 1,
        ...
        >
          ...
          <main
            ...
            style={{
              padding: 16,
              paddingBottom: "var(--nav-h)",     // loc pentru bara reală (setată de BottomNav)
              maxWidth: 1200,
              margin: "0 auto",
              width: "100%",
              ...
              // mic hint pt. iOS PWA ca să nu “sape” body-ul
