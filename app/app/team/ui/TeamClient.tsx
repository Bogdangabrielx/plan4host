      ...
      <style jsx>{`
        @media (max-width: 720px) {
          ...
          .scopeItem {
            ...
            border: 1px solid var(--border); background: "var(--panel)"; padding: 6px 8px; border-radius: 8px;
          }
        }
        @media (min-width: 721px) {
          .scopesWrap { display: grid; grid-template-columns: repeat(4, minmax(0,1fr)); gap: 8px; }
          .scopeItem { display: flex; gap: 6px; background: "var(--panel)"; align-items: center; border: 1px solid var(--border); padding: 6px 8px; border-radius: 8px; }
        }
      `}</style>
    </div>
  );
