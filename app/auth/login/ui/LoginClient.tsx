...
/* Wrapper full-page: padding responsiv cu min(5em, 8%) */
...
const headRow: React.CSSProperties = {
  display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, marginBottom: 10,
};

const input: React.CSSProperties = {
  padding: "10px 12px", background: "var(--bg)", color: "var(--text)",
  border: "1px solid var(--border)", borderRadius: 8, width: "100%",
};
...
const primaryBtn: React.CSSProperties = {
  ...
  background: "var(--primary)", color: "#0c111b", fontWeight: 800, cursor: "pointer", width: "100%",
};

const oauthBtn: React.CSSProperties = {
  padding: "10px 14px", borderRadius: 10, border: "1px solid var(--border)",
  background: "var(--card)", color: "var(--text)", fontWeight: 800, cursor: "pointer",
