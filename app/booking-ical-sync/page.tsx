...
export default function BookingIcalSyncPage() {
  ...
  return (
    <main className={`${styles.landing} ${seoMontserrat.className}`} style={{ minHeight: "100dvh", overflowX: "hidden" }}>
      ...
      <SeoStructuredData
        lang="en"
        path="/booking-ical-sync"
        title="Booking.com iCal sync - connect your calendar | Plan4Host"
        description="A short guide for Booking.com iCal sync: import reservations into Plan4Host and export availability back to reduce double bookings."
        image="/booking.png"
