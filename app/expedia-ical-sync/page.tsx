...
export default function ExpediaIcalSyncPage() {
  ...
  return (
    <main className={`${styles.landing} ${seoMontserrat.className}`} style={{ minHeight: "100dvh", overflowX: "hidden" }}>
      ...
      <SeoStructuredData
        lang="en"
        path="/expedia-ical-sync"
        title="Expedia iCal sync - connect your calendar | Plan4Host"
        description="A short guide for Expedia iCal sync: import reservations into Plan4Host and export availability back to reduce overlaps."
        image="/expedia.png"
