    ...
    <main className={s.page}>
      <div className={s.container}>
        <header className={s.header}>
          <div className={s.headerInner}>
            ...
            <div className={s.headerMetaRow}>
              ...
              <p className={s.meta}>Applies to: plan4host.com and the application area</p>
            </div>
          </div>
        </header>
        ...
        <section>
          ...
          <h2 className={s.h2}>2.1. Web Push notifications</h2>
          <p className={s.p}>
            If you enable Web Push notifications, the application stores a subscription record in our database so we can
            deliver messages to your device. This record includes: the push <em>endpoint</em> (a URL generated by your
          ...
          <div className={s.card} style={{ marginTop: 8 }}>
            <p className={s.p} style={{ margin: 0 }}>
              ...
              under GDPR Art. 6(1)(f) (legitimate interests). <strong>The ID image is automatically deleted immediately
              when your reservation is confirmed and a room is assigned.</strong> You may redact sensitive fields before
              upload. Please keep your face and the fields you typed visible, and mask: personal numerical code
              (CNP/personal number), document series/number, full address, and the MRZ area on passports. We do not use the
              image for facial recognition or biometric profiling.
            </p>
          </div>
          <p className={s.p}>
