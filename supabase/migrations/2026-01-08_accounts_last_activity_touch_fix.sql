-- plan4host — make touch_account_activity resilient
-- Date: 2026-01-08
...
begin
  ...
  -- Throttle to at most once per 15 seconds per account.
  update public.accounts a
  set last_activity_at = now()
  where a.id = target_account_id
    and (a.last_activity_at is null or a.last_activity_at < now() - interval '15 seconds');
end;
$fn$;
